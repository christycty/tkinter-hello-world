...
minuteEntry = Entry(root, width=5, font=("Arial", 80, ""), textvariable=minute)
minuteEntry.place(x=80, y=50)

secondEntry = Entry(root, width=5, font=("Arial", 80, ""), textvariable=second)
